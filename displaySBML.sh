...
#
# displaySBML.sh Copyright (C) 2009 Andreas Dräger"
# This program comes with ABSOLUTELY NO WARRANTY."
# This is free software, and you are welcome to redistribute it"
# under certain conditions. See GNU GPL for details."
...
${DISPLAYSBMLPATH}/lib/linux${PROCESSOR}/libSBML/share/java/libsbmlj.jar:\
...
if [ $# -ge 1 ]; then
  ...
  command="${JAVA_HOME}/bin/java ${VM_ARGS} -cp ${CLASSPATH} ${MAIN_CLASS} "$1
  if [ $outfile != "-.tex" ]; then
 ...
 echo "usage: ./displaySBML.sh <infile.xml [format] [options] || [infile.xml] --gui [options]>"
