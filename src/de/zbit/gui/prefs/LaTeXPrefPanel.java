/*
 * $Id: LaTeXPrefPanel.java 60 2011-03-07 17:20:39Z draeger $
 * $URL: https://rarepos.cs.uni-tuebingen.de/svn/SBML2LaTeX/tags/version0.9.8/src/de/zbit/gui/prefs/LaTeXPrefPanel.java $
 * ---------------------------------------------------------------------
...
public class LaTeXPrefPanel extends PreferencesPanel {
	...
	lh.add(
	    createGroup(LaTeXOptions.CONFIGURATION_FILES, unprocessedOptions),
	    0, 0, 2, 1, 1d, 1d);
	lh.add(createGroup(LaTeXOptions.REPORT_OPTIONS, unprocessedOptions), 0,
	    1, 1, 1, 1d, 1d);
	lh.add(createGroup(LaTeXOptions.LAYOUT_OPTIONS, unprocessedOptions), 1,
	    1, 1, 1, 1d, 1d);
	lh.add(createGroup(LaTeXOptions.TYPOGRAPHICAL_OPTIONS,
	    unprocessedOptions), 0, 2, 2, 1, 1d, 1d);
	// JPanel panel = new JPanel(new BorderLayout());
	// panel.add(createGroup(LaTeXOptions.TYPOGRAPHICAL_OPTIONS,
	// unprocessedOptions), BorderLayout.CENTER);
	// LayoutHelper helper = new LayoutHelper(new JPanel());
	// helper.add(new JPanel(), 0, 0, 1, 1, 1d, 0d);
	// helper.add(new JLabel(UIManager.getIcon("ICON_LATEX_SMALL")), 1, 0,
	// 1, 1, 0d, 0d);
