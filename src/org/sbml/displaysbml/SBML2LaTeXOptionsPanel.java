...
public class SBML2LaTeXOptionsPanel extends JPanel implements ActionListener {
	...
	public SBML2LaTeXOptionsPanel() {
		...
		checkImplicitUnits.setToolTipText("<html>If selected, all predefined unit declarations are<br>" +
		...
		checkLandscape.setToolTipText("<html>If selected, the paper format will be changed to landscape.<br>" +
		...
		checkTypeWriter.setToolTipText("<html>If selected, a typewriter font is applied to<br>" +
				"highlight SBML identifiers.</html>");
		checkTitlepage = new JCheckBox("<html>Create a title page</html>",
				false);
		checkTitlepage.setToolTipText("<html>If selected, a separate title page will be created. By<br>" +
		...
		checkNameIfAvailalbe.setToolTipText("<html>If selected, the names of SBML elements are displayed <br>" +
		...
		checkIncludeMIRIAM = new JCheckBox("<html>MIRIAM annotations</html>",
				false);
		checkIncludeMIRIAM.setToolTipText("<html>If selected, the MIRIAM.xml file is parsed to provide<br>" +
		...
		checkOneTableForReactionParticipants = new JCheckBox(
				...
				false);
		checkOneTableForReactionParticipants.setToolTipText("<html>If selected, all reactants, modifiers and producst of a<br>" +
		...
		checkShowSBMLerrors.setToolTipText("<html>If selected, the given SBML file is validated using libSBML's <br>" +
		...
		optionPaperSize.setToolTipText("<html>This option allows you to choose the paper size. Besides the<br>" +
		...
		optionFontSize.setToolTipText("<html>This allows you to select the size of the standard<br>" +
				"text font. Headings appear with a larger font.</html>");
		sbmlFileField = new JTextField(15);
		sbmlFileField.setEditable(false);
		sbmlFileField.setToolTipText("<html>The SBML source file to be converted to LaTeX.</html>");
		teXFileField = new JTextField(15);
		teXFileField.setEditable(false);
		teXFileField.setToolTipText("<html>Path of the file to which the output will be written.</html>");
		optionFontText = new JComboBox(new String[] { "chancery", "charter",
				"cmr", "palatino", "times", "utopia" });
		optionFontText.setSelectedIndex(3);
		optionFontText.setToolTipText("<html>Select the font to be used for standard continuos text</html>");
		optionFontHeadings = new JComboBox(new String[] { "avant",
				"cmss", "helvetica" });
		optionFontHeadings.setSelectedIndex(2);
		optionFontHeadings.setToolTipText("<html>Select the font to be used for all headlines.</html>");
		optionFontTypewriter = new JComboBox(new String[] { "cmt", "courier" });
		optionFontTypewriter.setSelectedIndex(0);
		optionFontTypewriter.setToolTipText("<html>Select a typewriter font that can be used for identifiers if<br>" +
		...
		LayoutHelper.addComponent(panel, gbl, new JLabel("SBML file "), 0, 0,
				1, 1, 1, 0);
		LayoutHelper.addComponent(panel, gbl, sbmlFileField, 1, 0, 1, 1, 1, 0);
		JButton button = new JButton("Browse");
		button.setName("browse sbml");
		button.setToolTipText("Click here to choose a file.");
		button.addActionListener(this);
		LayoutHelper.addComponent(panel, gbl, button, 2, 0, 1, 1, 0, 0);
		LayoutHelper.addComponent(panel, gbl, new JLabel("TeX file "), 0, 1, 1,
				1, 1, 0);
		LayoutHelper.addComponent(panel, gbl, teXFileField, 1, 1, 1, 1, 0, 0);
		button = new JButton("Browse");
		button.setName("browse tex");
		button.setToolTipText("Click here to choose a file.");
		button.addActionListener(this);
		LayoutHelper.addComponent(panel, gbl, button, 2, 1, 1, 1, 0, 0);
		add(panel);
		...
		LayoutHelper.addComponent(panel, gbl, new JLabel("Main text font size"), 0, 2, 1,
				1, 0, 0);
		LayoutHelper.addComponent(panel, gbl, optionFontSize, 1, 2, 1, 1, 1, 0);
		LayoutHelper.addComponent(panel, gbl, new JLabel("Main text font"), 0, 3, 1, 1, 0, 0);
		LayoutHelper.addComponent(panel, gbl, optionFontText, 1, 3, 1, 1, 0, 0);
		LayoutHelper.addComponent(panel, gbl, new JLabel("Headings font"), 0, 4, 1, 1, 0, 0);
		LayoutHelper.addComponent(panel, gbl, optionFontHeadings, 1, 4, 1, 1, 0, 0);
		LayoutHelper.addComponent(panel, gbl, new JLabel("Typewriter font"), 0, 5, 1, 1, 0, 0);
		LayoutHelper.addComponent(panel, gbl, optionFontTypewriter, 1, 5, 1, 1, 0, 0);
		// Check boxes
