...
public class TikZLayoutAlgorithm extends SimpleLayoutAlgorithm {
	...
	public TikZLayoutAlgorithm() {
		super();
		this.setOfAllGlyphs = new HashSet<GraphicalObject>();
	}
	...
	public Curve createCurve(ReactionGlyph reactionGlyph, SpeciesReferenceGlyph specRefGlyph) {
		...
		this.layoutLevel = layout.getLevel();
		this.layoutVersion = layout.getVersion();
	 ...
	 */
	private Position createSpeciesGlyphPosition(SpeciesGlyph speciesGlyph) {
	 ...
	 * @return position
	 */
	private Position createTextGlyphPosition(TextGlyph textGlyph) {
