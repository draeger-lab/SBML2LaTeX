  ...
  public void startElement(ElementStart element) {
    try {
      ...
      if (name.equals("a")) {
        ...
        _conv.tableRowStart(element);
      } else if (name.equals("td")) {
        _conv.tableCellStart(element);
      } else if (name.equals("th")) {
        _conv.tableCellStart(element);
      } else if (name.equals("meta")) {
        _conv.metaStart(element);
      } else if (name.equals("body")) {
        _conv.bodyStart(element);
      } else if (name.equals("font")) {
        _conv.fontStart(element);
      } else if (name.equals("img")) {
        _conv.imgStart(element);
      } else if (name.equals("table")) {
        _conv.tableStart(element);
      } else {
  ...
  public void endElement(ElementEnd element, ElementStart elementStart) {
    try {
      ...
      if (name.equals("a")) {
        ...
        _conv.tableRowEnd(element, elementStart);
      } else if (name.equals("th")) {
        _conv.tableCellEnd(element, elementStart);
      } else if (name.equals("td")) {
        _conv.tableCellEnd(element, elementStart);
      } else if (name.equals("table")) {
        _conv.tableEnd(element, elementStart);
      } else if (name.equals("body")) {
        _conv.bodyEnd(element, elementStart);
      } else if (name.equals("font")) {
        _conv.fontEnd(element, elementStart);
      } else {
